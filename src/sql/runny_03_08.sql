...
-- ----------------------------
BEGIN;
INSERT INTO `runny_log` VALUES ('1', '1', '10.21', '60.41', '192.4', '2017-03-05 16:12:14', null, '跑的我低血糖'), ('2', '1', '5.38', '30.87', '100.5', '2017-03-05 16:13:10', null, '这速度我自己都害怕'), ('3', '1', '8.80', '45.38', '150.3', '2017-03-05 16:15:30', null, '感觉自己好厉害'), ('4', '1', '12.00', '70.00', '180.9', '2017-03-07 19:49:14', null, '牛逼啊');
COMMIT;
...
-- ----------------------------
--  Records of `total_run`
-- ----------------------------
BEGIN;
INSERT INTO `total_run` VALUES ('1', '5', '1', '11082'), ('2', '100', '1', null);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES ('1', 'xiaohong', '123456', '2', 'https://ss1.baidu.com/6ONXsjip0QIZ8tyhnq/it/u=4225565668,46745471&fm=80&w=179&h=119&img.JPEG', '女', '180', '98', '2017-02-28 20:29:22', '浙江省宁波市鄞州区', '12', '3', '13', null), ('2', 'xiaoli', '123456', '2', 'https://ss1.baidu.com/6ONXsjip0QIZ8tyhnq/it/u=4225565668,46745471&fm=80&w=179&h=119&img.JPEG', '女', '180', '98', '2017-02-28 20:33:33', '浙江省宁波市鄞州区', '12', '3', '13', null), ('3', 'JasonWang', 'CF74FE3337EE674192CEF3DE846642AA05F517831F579E913D23373D', null, null, null, null, null, null, null, null, null, null, null), ('4', 'xiaoyao', '48E0B5B64D618D210C49F434F56C738C6865C5FDF2FBFAE93C2D6381', null, null, null, null, null, null, null, null, null, null, null);
COMMIT;
